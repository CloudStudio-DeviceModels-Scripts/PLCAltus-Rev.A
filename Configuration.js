...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Flow In", endpointType.volumeSensor);
  endpoints.addEndpoint("2", "Flow Out", endpointType.volumeSensor);
  endpoints.addEndpoint("3", "Pressure In", endpointType.pressureSensor);
  endpoints.addEndpoint("4", "Pressure Out", endpointType.pressureSensor);
  var e = endpoints.addEndpoint("5", "Density In", endpointType.genericSensor);
  e.variableTypeId = 1416;
  var e = endpoints.addEndpoint("6", "Density Out", endpointType.genericSensor);
  e.variableTypeId = 1416;
  endpoints.addEndpoint("7", "Motor Temperature", endpointType.temperatureSensor);
  var e = endpoints.addEndpoint("8", "Totalized", endpointType.genericSensor);
  e.variableTypeId = 1417;
}
