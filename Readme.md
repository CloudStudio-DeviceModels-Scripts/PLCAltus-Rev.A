...
# Parsing + Configuration Script – PLC Altus - Rev. A

This **Parsing + Configuration** script is designed for the **PLC Altus** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – PLC Altus Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **PLC Altus** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
